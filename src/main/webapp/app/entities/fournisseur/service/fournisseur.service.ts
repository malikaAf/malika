...
export class FournisseurService {
  ...
  deleteAll(fournisseur: IFournisseur[]): Observable<EntityArrayResponseType> {
    return this.http.put<IFournisseur[]>(this.resourceUrl + '/delleteAll', fournisseur, { observe: 'response' });
  }
