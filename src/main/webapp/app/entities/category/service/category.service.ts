...
export class CategoryService {
  ...
  deleteAll(categories: ICategory[]): Observable<EntityArrayResponseType> {
    return this.http.put<ICategory[]>(this.resourceUrl + '/delleteAll', categories, { observe: 'response' });
  }
