...
public class FournisseurResource {
    ...
    public List<FournisseurDTO> getAllFournisseurs() {
        ...
        return fournisseurService.findAll().stream().filter(fournisseurDTO -> !fournisseurDTO.getDeleted()).collect(Collectors.toList());
    }
    ...
    @PutMapping("/fournisseurs/delleteAll")
    public ResponseEntity<List<FournisseurDTO>> deleteAll(@RequestBody @Valid List<FournisseurDTO> fournisseurDTO) {
        return ResponseEntity.ok(fournisseurService.deleteAll(fournisseurDTO));
    }
}
