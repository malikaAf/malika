...
public class CategoryResource {
    ...
    @PutMapping("/categories/delleteAll")
    public ResponseEntity<List<CategoryDTO>> deleteAll(@RequestBody @Valid List<CategoryDTO> categoryDTOS) {
        // List<CategoryDTO> categoryDTOList = categoryService.deleteAll(CategoryDTO);
        System.out.println("==========================================");
        System.out.println(categoryDTOS);

        System.out.println("==========================================");

        return ResponseEntity.ok(categoryService.deleteAll(categoryDTOS));
    }
}
